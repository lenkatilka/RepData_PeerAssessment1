---
title: "Activity Pattern Assignment"
output:
  html_document:
    keep_md: yes
    self_contained: no
...
* The mean of the steps per day is `r mean_steps` steps.
* The median of the steps per day is `r median_steps` steps.
...
* The maximum average number of steps over all days is `r max_steps` for interval `r max_int`
...
na_values_count
```
The number of NA values is `r na_values_count`.
...
* The mean of the steps per day is `r mean_steps_f` steps.
* The median of the steps per day is `r median_steps_f` steps.
